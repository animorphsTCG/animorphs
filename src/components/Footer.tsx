        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="inline-block mb-4">
              <h1 className="text-2xl font-fantasy font-bold">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-400 hover:text-fantasy-accent">Home</Link>
              </li>
              <li>
                <Link to="/card-gallery" className="text-gray-400 hover:text-fantasy-accent">Cards</Link>
              </li>
              <li>
                <Link to="/battle" className="text-gray-400 hover:text-fantasy-accent">Battle</Link>
              </li>
              <li>
                <Link to="/register" className="text-gray-400 hover:text-fantasy-accent">Register</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="#" className="text-gray-400 hover:text-fantasy-accent">Contact</Link>
              </li>
              <li>
                <Link to="#" className="text-gray-400 hover:text-fantasy-accent">Privacy Policy</Link>
              </li>
            </ul>
          </div>
        </div>

...
export const AIAssistantPage = ({ onBack }: AIAssistantPageProps) => {
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      accept=".txt,.md,.json,.php,.js,.ts,.tsx,.jsx"
                      className="hidden"
                    />
                    <Button
            ...
            <Card className="bg-black/20 border-white/10 text-white">
              ...
              <CardContent className="space-y-4">
                <div className="h-96 overflow-y-auto bg-black/30 rounded-lg p-4 space-y-4">
                  ...
                  {isLoading && (
                    <div className="bg-purple-600/20 mr-8 p-3 rounded-lg">
                ...
                <div className="flex gap-2">
                  <Textarea
                    ...
                    placeholder="Ask about code, deployment, features, or debugging..."
                    className="bg-black/50 border-white/20 text-white"
                    rows={3}
                  />
                  <Button

  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <div className="max-w-4xl mx-auto bg-black/80 p-8 rounded-lg shadow-md border border-fantasy-accent/20">
        ...
        <p className="text-gray-400 mb-6">Last Updated: 09/April/2025</p>
        ...
        <ScrollArea className="h-[60vh]">
          <div className="prose prose-invert max-w-none pr-4">
            ...
            <p>
              ...
              <br />
              <a href="mailto:mythicmastersp2e@gmail.com" className="text-fantasy-accent">mythicmastersp2e@gmail.com</a>
            </p>
